...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{pics/Chapter3/ImprovedModel.drawio.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=.9\linewidth]{pics/Proposal/good_pitts.jpg}
    \caption{Ảnh biểu diễn tốt khu vực trong ảnh}
  \end{subfigure}
  \hspace{2cm}
  \begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=.9\linewidth]{pics/Proposal/bad_pitts.jpg}
