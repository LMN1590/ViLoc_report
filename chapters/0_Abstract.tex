\begin{abstract}
    ...
    \begin{itemize}
        \item MixVPR, được phát triển bởi Ali-bey và nnk vào năm 2023 cho bước nhận diện địa điểm trực quan, hỗ trợ đưa mô hình định vị lên phạm vị không gian rộng lớn.
        \item Mô hình ước tính vị trí máy ảnh 2D-2D được đề xuất trong Map-free Relocalization, phát triển bởi Arnold và nnk vào năm 2022, hỗ trợ tính toán vị trí và tư thế chính xác của máy ảnh trong không gian từ mỗi cặp ảnh.
    \end{itemize}
