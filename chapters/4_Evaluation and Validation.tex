...
Chúng tôi tiến hành thực hiện những thí nghiệm nhằm nghiên cứu những ảnh hưởng cũng như những đánh đổi về mặt kết quả của mô hình kết hợp ở các ngưỡng Inlier khác nhau trên hai tập dữ liệu Pittsburgh250k-test \cite{6618963} và Cambridge Landmark \cite{kendall2016posenet}. Kết quả được thể hiện ở bảng 4.4. Chúng tôi nhận xét càng tăng ngưỡng lên cao, độ lệch vị trí và độ lệch góc quay càng được cải thiện, nhưng đổi lại tỷ lệ truy xuất ảnh cũng giảm tương đối đáng kể. Với các tập dữ liệu phạm vi rộng và các góc nhìn về một cảnh tương đối lệch nhau, số lượng inlier correspondence khá thấp và vì thế tại ngưỡng (inlier > 5) và (inlier > 2), kết quả tương đối tốt. Ngược lại với tập dữ liệu như Cambridge Landmark, một cảnh sẽ có tương đối nhiều góc quay hướng vào, sẽ có lượng inlier correspondence tương đối cao. Ngoài ra, chúng tôi nhận thấy khi tăng ngưỡng lên một khoảng cố định, các sai lệch về vị trí và góc quay không còn được cải thiện đáng kể. Chúng tôi nhận xét đây là một hướng tiếp cận khá thú vị và dự kiến sẽ nghiên cứu thêm về một giải thuật xác định ngưỡng tối ưu với mỗi cơ sở dữ liệu được sử dụng.
% table
\bgroup
\def\arraystretch{1.4}%
\setlength\tabcolsep{10 pt}
...
\multirow{5}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Pittsburgh250k\\ -test \cite{6618963}\end{tabular}}} & Inliers \textgreater 0                                      & 0.98                                                                & 18.32                                                                    & 39.39                                                                        \\
                                                                                         & Inliers \textgreater 2                                      & 0.97                                                                & 13.44                                                                    & 38.13                                                                        \\
...
\multirow{4}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Cambridge \\ Landmark \cite{kendall2016posenet}\end{tabular}}}  & Inliers \textgreater 0                                      & 1.00                                                                & 3.19                                                                     & 4.80                                                                         \\
                                                                                         & \multicolumn{1}{l|}{Inliers \textgreater 25}                & 0.97                                                                & 3.18                                                                     & 4.65                                                                         \\
                                                                                         & \multicolumn{1}{l|}{Inliers \textgreater 35}                & 0.95                                                                & 3.16                                                                     & 4.35                                                                         \\
                                                                                         & \multicolumn{1}{l|}{Inliers \textgreater 50}                & 0.88                                                                & 3.14                                                                     & 4.34                                                                        
\end{tabular}
...
NetVLAD + RPR & 32768 & 0.99                                                                & 77.39                                                                    & 48.28                                                                       
\end{tabular}
...
Tiếp theo, chúng tôi tiến hành kiểm thử hiệu quả hướng tiếp cận reranking mô hình kết hợp trên tập dữ liệu Pittsburgh250k-test \cite{6618963}. Chúng tôi chọn các ngưỡng (k=1, 3, 5) ảnh để đo đạc và so sánh. Kết quả được thể hiện ở bảng 4.6. Chúng tôi nhận thấy do tính chất đa dạng góc quay của tập dữ liệu, số ảnh tăng từ bước VPR không cải thiện được hiệu quả, ngược lại có thể làm cho sai số tăng nhẹ. Điều này có thể lý giải bởi hai lý do: thứ nhất do không có quá nhiều khác biệt giữa trọng số cơ sở và trọng số đã được tinh chỉnh, thứ hai do bản chất của tập dữ liệu có ít ảnh trùng nhau giữa cơ sở dữ liệu và tập dữ liệu truy vấn - tức ngoài ảnh đầu tiên được truy xuất là chính xác thì các ảnh sau chỉ làm cho kết quả bị sai lệch chứ không cải thiện.
% table
\bgroup
\def\arraystretch{1.4}%
\setlength\tabcolsep{10 pt}
...
Reranking (k=5) & 0.9892                                                              & 19.22                                                                    & 41.30                                                                       
\end{tabular}
...
Kết quả mô hình kết hợp khi áp dụng bình quân trọng số trên tập dữ liệu Pittsburgh250k-test \cite{6618963} được chúng tôi đo đạc tại bảng 4.7. Một lần nữa, chúng tôi nhận xét rằng với một tập dữ liệu đa dạng về góc nhìn tại một vị trí, việc tăng số ảnh truy xuất từ VPR không cải thiện hiệu quả mà ngược lại làm giảm đi hiệu quả tương đối.
% table
\bgroup
\def\arraystretch{1.4}%
\setlength\tabcolsep{10 pt}
...
Weighted Pose (k = 5) & 0.9996                                                              & 25.48                                                                    & 40.21                                                                       
\end{tabular}
...
Với việc tập trung tinh chỉnh mô hình VPR theo hướng ưu tiên các ảnh có độ trùng lắp cao, kết quả được thể hiện ở bảng 4.8. Kết quả cho thấy hướng tiếp cận này vẫn không khả quan, có thể giải thích bởi: mô hình cơ sở vốn đã có thể chọn ảnh tốt nhất cả về vị trí lẫn độ trùng lắp, hoặc ảnh có độ trùng lắp cao được chọn nhưng tác vụ RPR lại không thể tính toán tư thế chính xác do sai lệch ở các mô hình tiền huấn luyện ở tác vụ này.
\bgroup
\def\arraystretch{1.4}%
\setlength\tabcolsep{10 pt}
\begin{table}[H]
...
Best Overlap Training & 0.9866                                                              & 26.92                                                                    & 42.15                                                                       
\end{tabular}
\caption{Ablation Study kết quả mô hình kết hợp khi áp dụng huấn luyện ưu tiên trùng lắp trên tập dữ liệu Pittsburgh250k-test \cite{6618963}}
\end{table}
\egroup
