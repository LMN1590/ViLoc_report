...
Để kiểm chứng kết quả đã được công bố trên bài báo khoa học của nhóm nghiên cứu tác giả, chúng tôi đã tiến hành chạy mô hình MixVPR trên tập dữ liệu Pittsburgh 250k \cite{6618963} và tập dữ liệu Pittsburgh 30k \cite{6618963}.
...
\section{Kết luận}
Chúng tôi đã có thể đo đạc và kiểm chứng các số liệu kết quả được công bố từ các bài báo khoa học được chọn trong mô hình kết hợp là thật và hoàn toàn đáng tin cậy. Dự kiến ở giai đoạn tiếp theo, chúng tôi sẽ tìm cách cải thiện kết quả các mô hình thuộc mô hình kết hợp hoặc tiếp tục nghiên cứu các mô hình cũng như các phương pháp tiếp cận tốt hơn để có thể giảm thiểu tối đa sai số về vị trí và góc quay.