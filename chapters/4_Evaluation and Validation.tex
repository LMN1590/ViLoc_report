...
Để kiểm chứng kết quả đã được công bố trên bài báo khoa học của nhóm nghiên cứu tác giả, nhóm đã tiến hành chạy mô hình MixVPR trên tập dữ liệu a thuộc nhóm tác giả b. Cụ thể tập dữ liệu bao gồm X ảnh chia thành khoảng hơn Y cảnh khác nhau.
