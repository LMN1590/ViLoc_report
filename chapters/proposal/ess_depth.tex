...
\subsection{Kết quả}
\subsubsection{Tập dữ liệu 7Scenes \cite{6619221}}
...
\begin{table}[H]
  \adjustbox{max width=\textwidth}{
    \begin{tabular}{lrcc}
      ...
      \multirow{-5}{*}{\textbf{\begin{tabular}[c]{@{}l@{}}Pose\\ Triangulation $\triangle$\end{tabular}}}           & \cellcolor[HTML]{34CDF9}\textbf{SuperGlue (Ess.Mat.)}                                    & \cellcolor[HTML]{34CDF9}\textbf{7 cm, 1.5°}                                  & \cellcolor[HTML]{34CDF9}\textbf{0.93/0.97}                                     \\
...
\subsubsection{Tập dữ liệu Niantic \cite{arnold2022mapfree}}
